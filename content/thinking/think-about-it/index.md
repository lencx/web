...
<!-- * >> *2016-12-28*<br />
  > **TODO:**
    * article (.md or .org) -> html ? generates
    * sass -> css response
    * express & pug -> for each article(date, author, title , more etc.) -> append to index
    * paging
    * archive
    * category
    * tag
...
<!-- * >> *2017-01-15*<br />
  > **DONE:**
  > 学习了一部分ES6语法及新特性：import ，promise ...，及js的一些编码规范。<br />
  > **TODO:** 头大，没有太大的进展。确实好多坑，要解决的问题：
    * entry //path
    * sass postcss -> css
    * js -> babel es5
    * img
...
<!-- * >> *2017-01-23*<br />
  > **DONE:** 今天sass编译成功。webpack.config.js也分离出来file模块，专门负责路径及名称。Plugins，Module正在考虑要不分离出来。<br />
  > 1.19-1.24歇业(💻不在身边，😭，离开你几天真有点不舍)。这几天我会看看书，顺便构思一下接下来的东西。
  * TODO
    * css文件的提取
    * img怎么处理？
    * express怎么接入
    * 浏览器热加载
    * gulp task如何处理webpack任务？
      - build
      - development
    * ... -->
