...
export default () => {
  ...
  const visibleBtn = () => {
    if (getScrollPosition().y > MIN_HEIGHT) {
      if (!isVisible) {
        setVisible(true)
      }
    } else {
